<x-admin-layout>
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Thêm Danh mục mới</h1>
        </div>
    </div>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" class="p-6 md:p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="col-span-full">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="icon" value="{{ old('icon') }}" placeholder="VD: 📱, 💻, 🚗" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">
                </div>

                <div class="col-span-full">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Mô tả chi tiết</label>
                    <textarea name="description" rows="3" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">{{ old('description') }}</textarea>
                </div>
            ...
            <div class="pt-6 border-t border-gray-100 dark:border-gray-700 flex justify-end gap-3">
                ...
                <button type="submit" class="px-6 py-2 text-sm font-medium text-white bg-indigo-600 rounded-lg shadow-sm hover:bg-indigo-700">Thêm Danh Mục</button>
            </div>
        </form>
    </div>
</x-admin-layout>
